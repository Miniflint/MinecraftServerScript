...
curl -o ${Name} ${Url}
[ -f ${Name} ] && echo -e "${NC}Installation of the server : [${green}OK${NC}]" || echo -e "${NC}Installation of the server : [${RED}NOT OK${NC}]" && exit
...
[ -s server.properties ] && echo -e "${NC}Server.properties overwrite: [${green}OK${NC}]" || echo -e "${NC}Server.properties overwrite: [${RED}NOT OK${NC}]" && exit
...
[ -f /opt/scripts ] && echo -e "${NC}Creation of the script: [${green}OK${NC}]" || echo -e "${NC}Creation of the script: [${RED}NOT OK${NC}]" && exit
sleep 3
printf "\033c"
